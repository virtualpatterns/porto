...
//   }
//   catch (error) {
//     showMessage(`An unknown error occurred refreshing the attendance (${error.message}).`)
//   }
//
// }
//
...
//   Log.info(`-   event.target.data-attendance-id=${event.target['data-attendance-id']}`)
...
//           'attendanceId': event.target['data-attendance-id'],
