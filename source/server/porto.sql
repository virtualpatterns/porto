...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`fficnar`@`%`*/ /*!50003 TRIGGER `porto`.`attendanceOnInsert` BEFORE INSERT ON `attendance` FOR EACH ROW
BEGIN
	call checkAttendance(null, new.userId, new.meetingId);
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`fficnar`@`%`*/ /*!50003 TRIGGER `porto`.`attendanceOnUpdate` BEFORE UPDATE ON `attendance` FOR EACH ROW
BEGIN
	call checkAttendance(new.attendanceId, new.userId, new.meetingId);
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    ...
    into	nextMeetingOn
	from 	weekday
	where 	weekday.from = weekday(curdate());
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`fficnar`@`%` PROCEDURE `deleteUser`(	in userId int )
BEGIN
...
BEGIN
    ...
    select  meeting.meetingId,
            ...
            ifnull(attendance.attended, false)  as attended
    from    meeting
                inner join user on
                    user.deleted is null
...
BEGIN
	...
	if not existsMeeting(null, nextMeetingOn) then
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`fficnar`@`%` PROCEDURE `updateUser`(	in userId int,
														in name varchar(100) )
BEGIN

	if (userId is null) then
		call insertUser(name);
    else
...
-- Dump completed on 2017-10-07  1:21:00
